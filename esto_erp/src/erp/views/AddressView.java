...
public class AddressView extends javax.swing.JPanel {
     ...
     * @param type
     */
    public AddressView(User user, UserRight right, Long keyItem, int type) {
        initComponents();
    ...
    private void initLocal(User user, UserRight right, Long keyItem, int type){
        controller = new AddressController(this, user, right, keyItem, type);
    ...
    public void loadDetail() {
        if (tblAddress.getSelectedRow() != -1){
            ...
            setCmbCountry(((Country)model.getValueAt(row, 7)).getId());
        } 
    }
    ...
    private void setCmbCountry(Long countryId){
        ...
        for (int i=0;i<cmbCountry.getItemCount() && index == -1;i++){
            ...
            if (obj.getId().longValue() == countryId){
                index = i;
            }
        }
