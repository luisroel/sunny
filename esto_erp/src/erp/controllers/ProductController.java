...
import erp.models.ProductModel;
...
public class ProductController implements ActionListener, ListSelectionListener {
    ...
    public ProductController(ProductView view, User user, UserRight right) {
        this.view = view;
    ...
    public void actionPerformed(ActionEvent ae) {
        switch (ae.getActionCommand()){
            ...
            case "Delete":
                ...
                break;
            default:
                JOptionPane.showMessageDialog(view, "Action not identified", "Unknown", JOptionPane.ERROR_MESSAGE);
                break;
        }
    }
   ...
   public void loadData(){
        ...
        tableModel = new ProductTableModel(model.getAll());
    ...
    private String validateData() {
        ...
        } else if (view.getColor().equals("")){
            msg = "A category must be selected";
        } else if (!Util.isNumeric(view.getWidthP())){
            msg = "Minimum stock field must be a numeric value";
        } else if (!Util.isNumeric(view.getHeightP())){
            msg = "Minimum stock field must be a numeric value";
        } else if (!Util.isNumeric(view.getLargeP())){
            msg = "Minimum stock field must be a numeric value";
    ...
    private String insertRecord() {
        ...
        obj = new Product(
                ...
                , view.getColor()
                , Float.parseFloat(view.getWidthP())
                , Float.parseFloat(view.getHeightP())
                , Float.parseFloat(view.getLargeP())
