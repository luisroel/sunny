...
import erp.controller.ProviderController;
...
public class ProviderView extends javax.swing.JInternalFrame {
     ...
     * @param right
     */
    public ProviderView(User user, UserRight right) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Provider"));

        jLabel16.setText("Prov. Id:");
        ...
        jTabbedPane2.addTab("Provider", pnlProvider);
    ...
    private void localInit(User user, UserRight right) {
        contactView = new ContactView(user, right, 1);
        addressView = new AddressView(user, right, 1);
        ...
        this.controller = new ProviderController(this, user, right);
