...
public class ProviderModel {
    ...
    public List<Provider> getAll() {
     ...
     public String insert(Provider obj, long userId) {
        CallableStatement cstmt = null;
        String msg = "";
        try {
            cstmt = connection.getSecurityConnection().prepareCall(
                    "{call sperp_insert_provider( ?,?,?,?,?,?, ?,?,?,?,?,?,?, ?,?,?,?,?,?,?,?,?,?, ?,? )}");
            ...
            cstmt.setLong("CountryId_p", obj.getAddress().getCountry().getId());
    ...
    public String update(Provider obj, long userId){
        CallableStatement cstmt = null;
        String msg = "";
        try {
            cstmt = connection.getSecurityConnection().prepareCall(
                    "{call sperp_update_provider( ?, ?,?,?,?,?,?, ?, ?,?,?,?,?,?,?, ?, ?,?,?,?,?,?,?,?,?,?, ?,? )}");
            ...
            cstmt.setLong("AddressId_p", obj.getAddress().getId());
            ...
            cstmt.setLong("ContactId_p", obj.getContact().getId());
    ...
    public String delete(long providerId){
        CallableStatement cstmt = null;
        String msg = "";
        try {
            cstmt = connection.getSecurityConnection().prepareCall(
                    "{call sperp_delete_provider(?,?)}");
            cstmt.setLong("Id_p", providerId);
            cstmt.registerOutParameter("Msg_p", java.sql.Types.VARCHAR);
            cstmt.execute();
            msg = cstmt.getString("Msg_p");
        } catch (Exception ex) {
