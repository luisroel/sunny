...
import erp.model.ProviderTableModel;
import erp.model.ProviderModel;
...
public class ProviderController implements ActionListener, ListSelectionListener {
    ...
    private final ProviderView view;
    private final UserRight right;
    private final User user;
    private int viewState;
    
    public ProviderController( ProviderView view, User user, UserRight right){
        this.view = view;
    ...
    public void loadData(){
        ProviderTableModel tableModel; 
        tableModel = new ProviderTableModel(model.getAll());
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = model.delete(view.getProviderId());
            if (!msg.isEmpty()){
    ...
    private String validateData() {
        ...
        } else if (view.getProviderName().equals("")){
            msg = "Name field cannot be empty";
